...
module.exports = function (dataObj) {
    ...
    /* var wardQuotaName = dataObj.additionalDetailsBean.wardname;

     if(wardQuotaName!=null && wardQuotaName == '1'){
     wardQuotaName="Ministerial";
     }
     else{
     wardQuotaName="Executive";
     } */
    ...
    var contentTamil = {
        ...
        "XII / HSC Certificate": {
            text: [' XII / HSC Certificate/ ', {
                text: 'பன்னிரெண்டாம் வகுப்பு/ தொழில் கல்வி சான்றிதழ்',
                font: 'latha',
            }]
        },
        "Diploma Certificate": {
    ...
    /*  if(returnStringIfNull(dataObj.getAgeQuotaDetailsRadioChk)=="" || returnStringIfNull(dataObj.getAgeQuotaDetailsRadioChk)==null){
     ...
     if(returnStringIfNull(dataObj.genderValDesc)=="Male" ||
     returnStringIfNull(dataObj.genderValDesc)=="Female"||
     returnStringIfNull(dataObj.genderValDesc)=="Transgender"){

     if(returnStringIfNull(dataObj.Govtemp)=="N"){

     if (returnStringIfNull(dataObj.additionalDetailsBean.wardsQuaota) !=null && returnStringIfNull(dataObj.additionalDetailsBean.wardsQuaota)!=""){
     contentCheck.push({
     margin: [0, 20, 0, 0],
     table: {
     widths: [170, '*'],
     ...
     [
     {
     text: ['Will You Like To Avail Wards Quota? /', {
     text: 'நீவிர் சார்ந்துள்ள வாரிசுக்கான இடஒதுக்கீடு பெற விரும்புகிறீரா?',
     font: 'latha',
     }]
     },
     [
     {text: returnStringIfNull(dataObj.additionalDetailsBean.wardsQuaota), bold: true}
     ],
     ]
     ]
     }, layout: 'noBorders'
     ...
     if (returnStringIfNull(dataObj.additionalDetailsBean.wardsQuaota) == "Yes") {
     contentCheck.push(
     {
     table: {
     widths: [170, '*'],
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.nameOfParent),bold:true}
     ]
     ]
     },layout: 'noBorders'
     }, {
     ...
     text: 'தற்போதைய பதவி (ஓய்வு பெறுவதற்கு/இறப்பதற்கு முன் கடைசியாக வகித்த பதவி)',
     font: 'latha',
     }]
     },
     {text: returnStringIfNull(dataObj.additionalDetailsBean.presentRank),bold:true}
     ]
     ]
     },layout: 'noBorders'
     });
     ...
     if(returnStringIfNull(dataObj.additionalDetailsBean.wardname) == "1") {   //for Ward name Ministrial
     contentCheck.push({
     table: {
     widths: [170, '*'],
     headerRows: 1,
     ...
     [
     {
     text: ['Present Posting (Or Last if Retired or Deceased) ‐ Unit /  ', {
     text: 'தற்போது பணிபுரியும் இடம் (ஓய்வு பெறுவதற்கு/இறப்பதற்கு முன் கடைசியாக பணியாற்றிய பிரிவு)',
     font: 'latha',
     }]
     },
     {text: returnStringIfNull(dataObj.additionalDetailsBean.presentPostingMini),bold:true}
     ]
     ]
     },layout: 'noBorders'
     });
     ...
     if(returnStringIfNull(dataObj.additionalDetailsBean.wardname) == "2") {      //for Ward name Executive
     contentCheck.push({
     table: {
     widths: [170, '*'],
     headerRows: 1,
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit),bold:true}
     ]
     ]
     },layout: 'noBorders'
     });

     if(returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) == "YOUTH BRIGADE" ||
     returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) == "TALUK POLICE"){
     ...
     [
     {
     text: ['Present Posting (Or Last if Retired or Deceased)  District / City / ', {
     text: ' தற்போது பணிபுரியும் இடம் (ஓய்வு பெறுவதற்கு/இறப்பதற்கு முன் கடைசியாக பணியாற்றிய மாவட்டம்/நகரம்/மாநகரம்)',
     font: 'latha',
     }]
     },
     {text: returnStringIfNull(dataObj.additionalDetailsBean.presentPosting),bold:true}
     ]
     ]
     },layout: 'noBorders'
     }, {
     ...
     [
     {
     text: ['Present Posting (Or Last if Retired or Deceased) Police Station / ', {
     text: 'தற்போது பணிபுரியும் இடம் (ஓய்வு பெறுவதற்கு/இறப்பதற்கு முன் கடைசியாக பணியாற்றிய காவல் நிலையம்) ',
     font: 'latha',
     }]
     },
     {text: returnStringIfNull(dataObj.additionalDetailsBean.policeStation),bold:true}
     ]
     ]
     },layout: 'noBorders'
     });
     }
     if(returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) == "OTHER"){
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.unitsOther),bold:true}
     ]
     ]
     },layout: 'noBorders'
     });
     ...
     if(returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) != "YOUTH BRIGADE"
     && returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) != "TALUK POLICE"
     && returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) != "POLICE HEADQUARTERS"
     && returnStringIfNull(dataObj.additionalDetailsBean.presentPostingUnit) != "OTHER"){
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.gpsNumber),bold:true}
     ]
     ]
     },layout: 'noBorders'
     }, {
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.wardsCertificateNumber),bold:true}
     ]
     ]
     },layout: 'noBorders'
     }, {
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.wardsCertIssuingAuthority),bold:true}
     ]
     ]
     },layout: 'noBorders'
     }, {
     ...
     {text: returnStringIfNull(dataObj.additionalDetailsBean.dateOfwardsCertificate),bold:true}
     ]
     ]
     },
     layout: 'noBorders'
